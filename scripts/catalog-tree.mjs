...
export const TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Bescherming Armbanden', slug: 'bescherming-armbanden' },
      { name: 'Liefde & Relaties', slug: 'liefde-relaties', alsoUnder: 'cadeaus-sets' },
      { name: 'Rust & Balans', slug: 'rust-balans' },
      { name: 'Kracht & Zelfvertrouwen', slug: 'kracht-zelfvertrouwen' },
      { name: 'Geluk & Voorspoed', slug: 'geluk-voorspoed' },
      { name: 'Chakra Armbanden', slug: 'chakra-armbanden' },
