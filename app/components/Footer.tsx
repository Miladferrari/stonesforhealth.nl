      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1">
                  <div className="flex items-center">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-3 h-3 text-[#492c4a] fill-current" viewBox="0 0 20 20">
        ...
        <div className="mt-12 border-t border-gray-300 pt-8 md:flex md:items-center md:justify-between">
          ...
          <div className="flex gap-x-6 md:order-2 justify-center md:justify-start">
            ...
            <a href="https://www.youtube.com" className="text-gray-600 hover:text-[#492c4a] transition-colors" target="_blank" rel="noopener noreferrer">
