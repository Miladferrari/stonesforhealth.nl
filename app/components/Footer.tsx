          ...
          <div className="space-y-8 flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700 font-medium font-[family-name:var(--font-eb-garamond)]">{`Gratis verzending ${bedragKort(GRATIS_VANAF)}+`}</span>
              </div>
            </div>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <Link href="/blog" className="text-base text-gray-800 font-medium hover:text-[#492c4a] transition-colors font-[family-name:var(--font-eb-garamond)]">
                      Blog
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-300">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-700 font-semibold font-[family-name:var(--font-eb-garamond)]">{`Gratis verzending ${bedragKort(GRATIS_VANAF)}+`}</span>
            </div>
            <div className="flex flex-col items-center">
              <svg className="w-6 h-6 text-[#492c4a] mb-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
