    ...
    <article className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            <span className="text-white/80 text-sm font-[family-name:var(--font-eb-garamond)]">
              29 januari 2025 • 9 min leestijd
            </span>
          </div>
          ...
          <p className="text-xl text-white/90 font-[family-name:var(--font-eb-garamond)]">
            Chinese astrologie 2025: Ontdek de wijsheid van het Jaar van de Houten Slang. Transformatie, intuïtie en spirituele groei met de beste edelstenen voor dit jaar.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 id="symboliek-slang" className="text-3xl font-bold text-gray-900 mt-12 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <h2 id="hout-element" className="text-3xl font-bold text-gray-900 mt-12 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <h2 id="voorspellingen-2025" className="text-3xl font-bold text-gray-900 mt-16 mb-8 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <h2 id="edelstenen-slang" className="text-3xl font-bold text-gray-900 mt-16 mb-8 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          {/* Section 5: Tips */}
          <h2 id="tips-slangenenergie" className="text-3xl font-bold text-gray-900 mt-16 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          {/* Section 6: Rituelen */}
          <h2 id="rituelen-2025" className="text-3xl font-bold text-gray-900 mt-16 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
              ...
              <Link href="/blog/jaar-van-het-vuurpaard-2026" className="group">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-900 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 font-[family-name:var(--font-eb-garamond)]">
                    Ontdek wat het volgende jaar brengt
                  </p>
                </div>
              </Link>
