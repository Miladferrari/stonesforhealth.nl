...
const blogPostingSchema = {
  ...
  "image": "https://stonesforhealth.nl/Blog images /Chakra's en hun Kleuren- De Energiepunten van je Lichaam.jpeg",
    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="relative w-full h-64 sm:h-96 my-8 rounded-xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200">
          <Image
            src="/Blog images /Chakra's en hun Kleuren- De Energiepunten van je Lichaam.jpeg"
