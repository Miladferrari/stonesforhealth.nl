    ...
    <article className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#492c4a] to-[#6b4069] text-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 font-[family-name:var(--font-eb-garamond)]">
            Ontdek hoe chakra kristallen je energiecentra kunnen balanceren en harmoniseren. Leer welke stenen bij welke chakra's horen en hoe je ze het beste kunt gebruiken.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 id="wat-zijn-chakras" className="text-3xl font-bold text-gray-900 mt-12 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
            Wat zijn Chakra's?
          </h2>
          ...
          <h2 id="waarom-chakra-kristallen" className="text-3xl font-bold text-gray-900 mt-12 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-16 mb-8 font-[family-name:var(--font-eb-garamond)]">
          ...
          <div id="wortelchakra" className="border border-gray-200 rounded-lg p-6 md:p-8 mb-6 scroll-mt-24">
            ...
            <h4 className="text-lg font-semibold text-gray-900 mb-4 font-[family-name:var(--font-eb-garamond)]">
              Beste Kristallen:
            </h4>
            <ul className="space-y-3 mb-6 pl-5 list-disc text-gray-700 font-[family-name:var(--font-eb-garamond)]">
          ...
          {/* Chakra Set Kopen */}
          <h2 id="chakra-set-kopen" className="text-3xl font-bold text-gray-900 mt-16 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <div className="not-prose bg-gradient-to-br from-[#492c4a] to-[#6b4069] rounded-xl p-8 my-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/alle-producten?category=chakra" className="bg-[#fbe022] hover:bg-[#e6cc1f] text-black px-8 py-3 rounded-lg font-bold transition-colors font-[family-name:var(--font-eb-garamond)]">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/blog" className="group">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-900 transition-colors">
                  <h3 className="font-bold text-gray-900 mb-2 group-hover:text-gray-700 transition-colors font-[family-name:var(--font-eb-garamond)]">
                    Hoe Reinig en Laad je Kristallen Op?
                  </h3>
                  <p className="text-sm text-gray-600 font-[family-name:var(--font-eb-garamond)]">
                    7 beproefde methoden voor optimaal onderhoud
                  </p>
                </div>
              </Link>
              <Link href="/blog" className="group">
              ...
              <Link href="/blog" className="group">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-900 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 font-[family-name:var(--font-eb-garamond)]">
                    Complete startgids voor nieuwe kristalliefhebbers
                  </p>
                </div>
              </Link>
            </div>
