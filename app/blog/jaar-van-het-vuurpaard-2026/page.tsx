    ...
    <article className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            <span className="text-white/80 text-sm font-[family-name:var(--font-eb-garamond)]">
              1 januari 2026 • 10 min leestijd
            </span>
          </div>
          ...
          <p className="text-xl text-white/90 font-[family-name:var(--font-eb-garamond)]">
            Chinese astrologie 2026: Ontdek wat het Jaar van het Vuurpaard betekent voor carrière, liefde, gezondheid en spiritualiteit. Inclusief gelukskleuren, nummers en beste edelstenen.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          {/* Section 1: Symboliek */}
          <h2 id="symboliek" className="text-3xl font-bold text-gray-900 mt-12 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <h2 id="voorspellingen" className="text-3xl font-bold text-gray-900 mt-16 mb-8 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <h2 id="gelukssymbolen" className="text-3xl font-bold text-gray-900 mt-16 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-gradient-to-br from-[#492c4a] to-[#6b4069] text-white rounded-xl p-6">
              ...
              <p className="text-3xl font-bold mb-2 font-[family-name:var(--font-eb-garamond)]">2, 3, 7, 9</p>
              <p className="text-sm text-white/80 font-[family-name:var(--font-eb-garamond)]">
            ...
            <div className="bg-gradient-to-br from-red-600 to-red-700 text-white rounded-xl p-6">
              ...
              <p className="text-lg font-bold mb-2 font-[family-name:var(--font-eb-garamond)]">Rood • Goud • Groen</p>
              <p className="text-sm text-white/80 font-[family-name:var(--font-eb-garamond)]">
            ...
            <div className="bg-gradient-to-br from-amber-600 to-amber-700 text-white rounded-xl p-6">
              ...
              <p className="text-lg font-bold mb-2 font-[family-name:var(--font-eb-garamond)]">Vuur + Aarde</p>
              <p className="text-sm text-white/80 font-[family-name:var(--font-eb-garamond)]">
          ...
          <h2 id="edelstenen-2026" className="text-3xl font-bold text-gray-900 mt-16 mb-8 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          {/* Section 5: Tips */}
          <h2 id="tips" className="text-3xl font-bold text-gray-900 mt-16 mb-6 font-[family-name:var(--font-eb-garamond)] scroll-mt-24">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 md:p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4 font-[family-name:var(--font-eb-garamond)]">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/blog/edelstenen-per-sterrenbeeld-numerologie" className="group">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-900 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 font-[family-name:var(--font-eb-garamond)]">
                    Ontdek welke edelsteen perfect bij jou past
                  </p>
                </div>
              </Link>
              <Link href="/blog/chakra-kristallen-complete-gids" className="group">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-900 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 font-[family-name:var(--font-eb-garamond)]">
                    Leer welke stenen bij elk chakra horen
                  </p>
                </div>
              </Link>
              <Link href="/blog/volle-maan-december-2025" className="group">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-900 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 font-[family-name:var(--font-eb-garamond)]">
                    Cold Moon rituelen en edelstenen
                  </p>
                </div>
              </Link>
            </div>
