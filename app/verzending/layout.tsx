...
export const metadata: Metadata = {
  title: 'Verzending & Levering | Gratis vanaf €30 | StonesForHealth',
  description: 'Informatie over verzending en levering ✓ Gratis verzending vanaf €30 ✓ Snelle levering binnen 2-4 werkdagen ✓ Track & Trace ✓ Zorgvuldig verpakt',
