...
export const metadata: Metadata = {
  ...
  description: 'Browse door onze volledige collectie edelstenen en kristallen ✓ 100+ authentieke stenen ✓ Gratis verzending €30+ ✓ Amethist, Rozenkwarts, Bergkristal, Agaat & meer',
