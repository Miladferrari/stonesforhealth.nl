                    ...
                    {shipping.loading ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          disabled={loading}
                          className="w-full bg-[#492c4a] text-white py-3 px-6 rounded-full font-semibold hover:bg-[#6b4069] transition-all transform hover:scale-[1.02] disabled:bg-gray-300 font-[family-name:var(--font-eb-garamond)] flex items-center justify-center"
                        >
                          {loading ? (
                            <>
