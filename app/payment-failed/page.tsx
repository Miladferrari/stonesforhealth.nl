          ...
          {hasOrderData ? (
            <>
              <button
                ...
                className="w-full bg-amber-orange text-white py-4 px-6 rounded-md font-semibold hover:bg-amber-orange/90 transition-all transform hover:scale-[1.02] flex items-center justify-center font-[family-name:var(--font-eb-garamond)] text-xl"
              >
            ...
            <Link
              href="/cart"
              className="block w-full bg-amber-orange text-white py-4 px-6 rounded-md font-semibold hover:bg-amber-orange/90 transition-all transform hover:scale-[1.02] text-center font-[family-name:var(--font-eb-garamond)] text-xl"
            >
